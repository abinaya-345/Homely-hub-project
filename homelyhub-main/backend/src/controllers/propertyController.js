...
const getProperty = async (a, b) => {
  ...
  createProperty = async (a, b) => {
    try {
      ...
      console['error']('Error\x20searching\x20properties', s),
        b['status'](0x194)['json']({
          message: 'fail',
  ...
  getProperties = async (a, b) => {
    try {
      const c = new APIFeatures(Property['find'](), a['query'])
          ['filter']()
          ['search']()
          ['paginate'](),
        d = await Property['find'](),
        e = await c['query'];
      b['status'](0xc8)['json']({
        status: 'success',
      ...
      console['error']('Error\x20searching\x20properties:\x20', f),
        b['status'](0x1f4)['json']({ error: 'Internal\x20server\x20Error' });
    }
  },
  getUsersProperties = async (a, b) => {
    try {
      const c = a['user']['_id'],
        d = await Property['find']({ userId: c });
      b['status'](0xc8)['json']({
        status: 'success',
        data: d,
      });
